...
public class Main_Menu extends JFrame {
	...
	public Main_Menu(String str) {
		...
		JLabel lblNewLabel = new JLabel("Housing");
		...
		JLabel lblNewLabel_3 = new JLabel("Housing.com");
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HousingWindow transport = new HousingWindow();
		...
		btnNewButton_9.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Thank you for using Housing.com!");
				//close main menu
				dispose();
			}
		});
